...
import { validateSchema } from '@repo/schema-validator';
import type { FieldConfig, IFormSchema } from '@repo/schema-validator';
...
const DynamicFormBuilder = ({
    ...
    const handleSchemaTextChange = (e: React.ChangeEvent<HTMLTextAreaElement>) => {
        ...
        SchemaParser(text).then((parsedData) => {
            ...
            console.log("error in parsing schema", _err);
